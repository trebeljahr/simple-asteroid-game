function draw() {
  ...
  pop()    
  player.showHealth()
  socket.emit('playerUpdate', { pos: {x: player.pos.x, y: player.pos.y}, vel: {x: player.vel.x, y: player.vel.y}, rotation: player.rotation, thrusterON:keyIsDown(UP_ARROW) || keyIsDown(W_KEYCODE)})
}
