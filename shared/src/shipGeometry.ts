...
export const getShipColliderBroadPhaseAabb = (collider: ShipCollider): CollisionAabb => {
...
export const shipCollidersOverlap = (firstCollider: ShipCollider, secondCollider: ShipCollider) => {
